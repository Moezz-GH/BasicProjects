...
<!-- Main modal -->
<div id="deleteModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto bg-slate-50 bg-opacity-20 backdrop-blur-lg border-gray-200 rounded-lg shadow overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
...
<div class="p-6 fixed top-0 z-50 right-0">
<div id="toast-success"
class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 border bg-slate-50 bg-opacity-20 backdrop-blur-lg border-gray-200 rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
role="alert">
<div
...
<div class="ml-3 text-sm text-black font-normal">Paid successfully.</div>
<button type="button" class="ml-auto -mx-1.5 -my-1.5  text-black hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700" data-dismiss-target="#toast-success" aria-label="Close">
